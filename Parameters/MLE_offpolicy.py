...
training_group = parser.add_argument_group('MLE_training')
...
training_group.add_argument('--SAC_batch_size',type=int,default=256)
...
training_group.add_argument('--lr_alpha', type=float, default=0.0003)
...
training_group.add_argument('--log_freq',type=int,default=10000)
training_group.add_argument('--reward_factor',type=float,default=1.0)
training_group.add_argument('--tau',type=float,default=5e-3)
training_group.add_argument('--start_steps',type=int,default=int(5000))
...
os.makedirs(weight_path,exist_ok=True)
weight_path = os.path.join(weight_path,'MLE_offpolicy')
